package ConditionalSatement_Day4;
...
public static void main(String[] args) {
    ...
    if(a%2==0)
        ...
        System.out.println("a is not divisble by 2");
    ...
    if(b%3==0 && c%5==0)
        System.out.println("b is divisble by 3 and c is divisble by 5");
    else
        System.out.println("b is not divisble by 3 and c is not divisble by 5");
    ...
    if(b%3==0 || c%5==0)
        System.out.println("bis divisble by 3 or c is divisble by 5");
    else
        System.out.println("b is not divisble by 3 neither c is not divisble by 5");
    ...
    if(b%4==0 && c%6==0)
        System.out.println("b is divisible by 4 and c is divisible by 6");
    else if(b%5==0 || b%7==0)
        System.out.println("b is either divisible by 5 or 7");
    else
        System.out.println("b or b is divisible by any of the above numbers");

    String s4="New Condition Check";

    char c5=s4.charAt(10);

    System.out.println("Printing value of S4"+(int)c5); //Prints the ASCII Value of the character

    if(c5%4==0)
    {
        System.out.println("c5 is divisble by 4");
    }
    ...
    if((d2-d5) == c2%2)
        System.out.println("d2 and d5 are equal");

    else if(d2%d5==c2)
        System.out.println("{d2} and {d5} are equal to {c2}");

    else
        System.out.println("{d2} and {d5} are not equal to {c2}");
    ...
    if(d10%2==0)
        System.out.println("{d10} is divisible by 2");
    else if(d10%3==0)
        System.out.println("{d10} is divisible by 3");
    else if(d10%5==0)
        System.out.println("{d10} is divisible by 5");
    else
        System.out.println("{d10} is not divisible by 2,3,5");
}
}
